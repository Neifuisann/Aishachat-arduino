...
#define VAD_SPEECH_THRESHOLD    1400.0f    // RMS energy threshold for speech start
#define VAD_SILENCE_THRESHOLD   1200.0f    // RMS energy threshold for speech end (hysteresis)

// Timing parameters (in frames, where each frame = 20ms)
#define VAD_PREFIX_FRAMES       15         // 300ms prefix padding (15 * 20ms)
